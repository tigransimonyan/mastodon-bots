...
const smokingHarms = [
	'Թոքերի քաղցկեղի հիմնական պատճառը. Ծխախոտը համարվում է թոքերի քաղցկեղի առաջացման հիմնական պատճառներից մեկը։ Ակտիվ ծխողների մոտ քաղցկեղի ռիսկը շատ ավելի բարձր է, քան ոչ ծխողների մոտ։',
	'Սրտանոթային հիվանդություններ. Ծխախոտի մեջ եղած նիկոտինն ու մյուս քիմիական նյութերը նպաստում են սրտանոթային հիվանդությունների առաջացմանը, ներառյալ ինֆարկտը և կաթվածը։',
	'Շնչառական հիվանդություններ. Ծխելը կարող է հանգեցնել քրոնիկ շնչառական հիվանդությունների, ինչպիսիք են քրոնիկ բրոնխիտը և էմֆիզեման, ինչը դժվարացնում է թթվածնի տեղափոխումը և թոքերի աշխատանքը։',
	'Նիկոտինային կախվածություն. Ծխախոտը պարունակում է նիկոտին, որն առաջացնում է ուժեղ կախվածություն։ Նիկոտինը ազդում է ուղեղի վրա և դժվարացնում է ծխելու դադարեցումը։',
	'Մեծացնում է այլ տեսակի քաղցկեղների առաջացման ռիսկը. Բացի թոքերի քաղցկեղից, ծխելը մեծացնում է կոկորդի, բերանի խոռոչի, լյարդի, ենթաստամոքսային գեղձի և այլ օրգանների քաղցկեղների առաջացման ռիսկը։',
	'Ծխախոտը վնասում է ծխողից դուրս գտնվող մարդկանց. Ծխախոտի երկրորդական ծուխը վնասում է ոչ միայն ծխողին, այլև այն մարդկանց, ովքեր շնչում են այդ ծուխը։ Այդպիսի ծխի ազդեցության տակ գտնվող մարդիկ նույնպես մեծացնում են սրտանոթային և շնչառական հիվանդությունների ռիսկը։',
	'Մեծացնում է հղիության խնդիրները. Ծխող կանանց մոտ մեծանում է վաղաժամ ծննդաբերության, պտղի ցածր քաշի, ինչպես նաև հղիության ընթացքում բարդությունների առաջացման ռիսկը։',
	'Մաշկի ու արտաքին տեսքի վրա ազդեցություն. Ծխախոտը վատացնում է մաշկի որակը, առաջացնում է վաղաժամ կնճիռներ և ընդհանուր տեսքի վատթարացում։',
	'Իմունային համակարգի թուլացում. Ծխելը թուլացնում է օրգանիզմի իմունային համակարգը, ինչը մեծացնում է տարբեր վարակների և հիվանդությունների նկատմամբ զգայունությունը։',
	'Թթվածնի կլանման խոչընդոտում. Ծխելը նվազեցնում է օրգանիզմի հյուսվածքներում թթվածնի քանակը, ինչը կարող է առաջացնել ֆիզիկական ուժի անկում և այլ առողջական խնդիրներ։',
	'Ատամների և լնդերի հիվանդություններ. Ծխելը վնասում է ատամները՝ առաջացնելով դեղնացում, քարերի կուտակում և լնդերի հիվանդություններ, ինչպիսիք են պերիօդոնտիտը։ Սա կարող է հանգեցնել ատամների կորստի։',
	'Սեռական դիսֆունկցիա. Ծխելը կարող է առաջացնել էրեկցիայի խնդիրներ տղամարդկանց մոտ, քանի որ նիկոտինը խոչընդոտում է արյան հոսքը դեպի սեռական օրգաններ։',
	'Անպտղություն. Ծխելը կարող է վնասել վերարտադրողական համակարգը ինչպես տղամարդկանց, այնպես էլ կանանց մոտ, նվազեցնելով վերարտադրողական ֆունկցիաները և մեծացնելով անպտղության ռիսկը։',
	'Զարգացման խնդիրներ երեխաների մոտ. Ծխող ծնողների երեխաները ավելի հակված են ունենալ զարգացման խնդիրներ, ինչպես նաև մեծանում է հանկարծակի մանկական մահվան սինդրոմի (SIDS) առաջացման հավանականությունը։',
	'Էկոլոգիական վնաս. Ծխախոտի արտադրությունն ու ծխախոտի մնացորդների (մոխիր, գլանակների ֆիլտրներ) թափոնները վնասում են շրջակա միջավայրը։ Ծխախոտի մնացորդները լուրջ աղբի աղբյուր են և հաճախ հայտնվում են ջրային և հողի էկոհամակարգերում։',
	'Ծերացման արագացում. Ծխելու պատճառով մաշկը կորցնում է առաձգականությունը, ինչը հանգեցնում է վաղաժամ ծերացման, ինչն արտահայտվում է ոչ միայն մաշկի վրա, այլև ողջ օրգանիզմում։',
	'Տեսողության խնդիրներ. Ծխողները ավելի մեծ ռիսկի են ենթարկվում տարիքային մացառախտի (macular degeneration) և կատարակտի առաջացման համար, ինչը կարող է հանգեցնել տեսողության կորստի։',
	'Քրոնիկ ցավեր. Ծխողները հաճախ են տառապում քրոնիկ ցավերով, օրինակ՝ մեջքի ցավերով, քանի որ ծխախոտը կարող է վնասել ոսկրերի և հոդերի առողջությունը։',
	'Հոգեբանական խնդիրներ. Ծխողների մոտ կարող են մեծանալ տագնապի, դեպրեսիայի և այլ հոգեբանական խնդիրների ռիսկերը, հատկապես այն ժամանակ, երբ նրանք փորձում են թողնել ծխելը։',
	'Սոցիալական մեկուսացում. Որոշ երկրներում և հասարակություններում ծխելը սոցիալական մերժում է առաջացնում, ինչը կարող է հանգեցնել սոցիալական մեկուսացման և խարանների։',
	'Տնտեսական խնդիրներ. Ծխախոտի օգտագործումը ծախսատար է, և ժամանակի ընթացքում ծխողների համար ծխախոտի գնումները կարող են լուրջ տնտեսական բեռ դառնալ։',
	'Արագացնում է ոսկրերի կոտրվածքի ռիսկը. Ծխող մարդիկ ավելի հակված են ունենալ ոսկրերի խտության նվազում, ինչը կարող է հանգեցնել կոտրվածքների և օստեոպորոզի զարգացման։',
];
