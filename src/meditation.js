...
const tips = [
	...
	"Կեանքը այն չէ, ինչ դու ուզում ես, որ լինի։ Այն այն է, ինչ կայ։ Երբ փորձում ես այն դարձնել այն, ինչ չէ, դու խնդիրներ ունես։",
	"Քո կեանքի որակը որոշւում է քո փորձառութեան խորութեամբ։",
	"Երջանկութիւնը այն բանը չէ, որ կարելի է հետապնդել։ Այն հետեւանք է։ Եթե կարգաւորես քո կեանքը որոշակի ձեւով, երջանկութիւնը կլինի։",
	"Եթե դիմադրում ես փոփոխութեան, դիմադրում ես կեանքին ինքնին։",
	"Խաղաղութիւնը կոնֆլիկտի բացակայութիւնը չէ, այլ կոնֆլիկտը խաղաղ միջոցներով լուծելու կարողութիւնն է։",
	"Եթե պատրաստ ես նայել քո կեանքին, կտեսնես, որ այն անընդհատ պար է հաճելի եւ անհաճոյի միջեւ։",
	"Սէրը ճիշտ մարդը գտնելու մասին չէ, այլ ճիշտ մարդը դառնալու մասին է։",
	"Որքան ավելի ես փորձում վերահսկել, այնքան ավելի քիչ սէր ունես։ Որքան ավելի ես փորձում սիրել, այնքան ավելի քիչ վերահսկողութիւն է պէտք։",
	"Հոգեւորութիւնը գերբնական լինելու մասին չէ, այլ գոյութեան բնութեան հասկանալու մասին է, որի մէջ դու գոյութիւն ունես։",
	"Երբ ինքդ քեզ նոյնացնում ես սահմանափակի հետ, դու լուրջ խնդիր ես դառնում քո համար։",
	"Փոխակերպումը քեզ փոխելու մասին չէ, այլ հասկանալու մասին է, թէ ով ես դու։",
	"Քո կեանքը իսկապէս փոխակերպելու միակ ճանապարհը քո կեանքի փորձառութիւնը փոխակերպելն է։",
	"Քո միտքը հրաշալի ծառայ է, բայց սարսափելի տէր։",
	"Եթե գիտակցաբար չես ստեղծում քո կեանքը, քո անգիտակցականը կստեղծի այն քեզ համար։",
	"Տառապանքը իրավիճակի պատճառով չէ, այլ քո անկարողութեան պատճառով է, որ չես կարողանում կառավարել իրավիճակը։",
	"Երբ դադարում ես տառապել, կտեսնես կեանքը այնպէս, ինչպէս կայ։",
	"Մահը կեանքի աւարտը չէ, այլ մարմնի աւարտն է։ Կեանքը շարունակւում է։",
	"Եթե ապրում ես մահուան գիտակցութեամբ, կապրես անսահման ինտենսիւութեամբ։",
	"Մարդու ներուժը անսահման է։ Միակ սահմանափակումը այն է, ինչ դու դրել ես քեզ համար։",
	"Եթե պատրաստ ես գնալ մինչեւ վերջ, կեանքը կհամաձայնուի քեզ հետ։",
	"Երբ դու գիտակցում ես, որ դու ոչինչ չես, դու ամեն ինչ ես։",
	"Կեանքը մի խաղ է։ Եթե դու լուրջ վերաբերմունք ունես, դու կկորցնես։",
	"Մի փորձիր լինել այն, ինչ ուրիշները ուզում են, որ դու լինես։ Լինել այն, ինչ դու ես, ամենամեծ նվաճումն է։",
	"Միայն այն մարդը, ով կարող է լինել մենակ, կարող է իսկապէս սիրել։",
	"Եթե դու չես փոխւում, դու չես աճում։ Եթե դու չես աճում, դու չես ապրում։",
	"Միայն այն մարդը, ով կարող է լինել անվախ, կարող է իսկապէս ազատ լինել։",
	"Կեանքը հնարաւորութիւն է, ոչ թէ խնդիր։",
];
...
const smokingHarms = [
	...
	"Ծխելը թողնելը հեշտ չէ, բայց ափսոսանքով ապրելը նույնպես: Ընտրեք այն դժվարությունը, որը տանում է դեպի ավելի լավ ապագա:",
	"Դուք ավելի ուժեղ եք, քան ձեր փափագները: Ամեն անգամ, երբ «ոչ» եք ասում ծխախոտին, դուք «այո» եք ասում ավելի առողջ և երջանիկ ձեզ:",
	"Ծխելը թողնելու լավագույն ժամանակը երեկ էր: Երկրորդ լավագույն ժամանակը այսօր է: Ձեր ապագա եսը կգնահատի ձեզ:",
	"Դուք այսքան հեռու չեք եկել միայն այսքան հեռու գնալու համար: Շարունակեք ձեր ճանապարհը՝ ձեր թոքերը, սիրտը և սիրելիները ձեզ քաջալերում են:",
	"Ամեն ծխախոտ, որ չեք ծխում, հաղթանակ է: Տոնեք փոքր հաղթանակները՝ դրանք կավելանան և կդառնան ազատության կյանք:",
	"Ծխելը թողնելով դուք ոչինչ չեք կորցնում: Դուք ձեռք եք բերում ամեն ինչ՝ առողջություն, էներգիա և երկար կյանք:",
	"Ծխելը թողնելու անհարմարությունը ժամանակավոր է, բայց անծխելի կյանքի օգուտները հավերժական են: Մնացեք ուժեղ:",
	"Դուք ազատվում եք կախվածության շղթաներից: Ամեն անցնող օրվա հետ դուք դառնում եք անկոտրում:",
	"Ձեր մարմինը ձեր տաճարն է: Ծխելը թողնելով դուք պատվում եք այն և տալիս եք ինքներդ ձեզ ավելի պայծառ ապագայի նվեր:",
	"Փափագները ալիքներ են՝ դրանք բարձրանում են, բայց նաև իջնում: Հաղթահարեք դրանք, և դուք կգտնեք հանգստություն:",
	"Դուք մենակ չեք այս ճանապարհին: Միլիոնավոր մարդիկ ձեր առաջ են թողել ծխելը, և ձեր ներսում կա նույն ուժը, որպեսզի հաջողության հասնեք:",
	"Ծխելը թողնելը ինքնասիրության գերագույն ակտն է: Դուք արժանի եք ազատ շնչելու և լիարժեք ապրելու:",
	"Ամեն օր առանց ծխախոտի մի օր է, երբ դուք վերահսկում եք ձեր կյանքը: Շարունակեք ձեր ճանապարհը՝ դուք արժեքավոր եք:",
	"Կարգապահության ցավը շատ ավելի քիչ է, քան ափսոսանքի ցավը: Մնացեք կարգապահ, և ձեր ապագա եսը կգնահատի ձեզ:",
	"Դուք ոչինչ չեք թողնում, դուք ձեռք եք բերում ամեն ինչ՝ մաքուր մաշկ, թարմ շնչառություն, ավելի շատ էներգիա և երկար կյանք:",
	"Փափագները կանցնեն, բայց ծխելը թողնելու հպարտությունը կմնա հավերժ: Շարունակեք առաջ գնալ:",
	"Դուք ավելի ուժեղ եք, քան կարծում եք: Ամեն անգամ, երբ դիմադրում եք ծխախոտին, դուք ապացուցում եք, թե որքան հզոր եք իրականում:",
	"Ծխելը թողնելը նման է սերմ տնկելուն: Դրա համար պահանջվում է ժամանակ, համբերություն և խնամք, բայց պարգևատրումը արժե այն:",
	"Դուք պարզապես սովորույթ չեք թողնում, դուք հետ եք վերադարձնում ձեր կյանքը: Ամեն ծխախոտից ազատ օրը արժանի է տոնելու:"
];
